...
const translations = {
    en: {
        ...
        skill_system_desc: "I specialize in <strong>game systems</strong>, <strong>3Cs</strong>, and <strong>balancing mechanics</strong>. I focus on creating <strong>deep, engaging player experiences</strong> through robust design documentation and iteration.",
    ...
    fr: {
        ...
        skill_system: "System Design",
        skill_system_desc: "Je me spécialise dans les <strong>systèmes de jeu</strong>, les <strong>3Cs</strong> et l'<strong>équilibrage des mécaniques</strong>. Je me concentre sur la création d'<strong>expériences de jeu profondes et engageantes</strong> grâce à une documentation de conception robuste et des itérations.",
        skill_management: "Management",
